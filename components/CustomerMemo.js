                ...
                <Modal isVisible={this.props.isVisible}>
                    <View style={{width:330, height:500, borderRadius:30, padding:20, marginLeft:5, flexDirection:'column', backgroundColor:'white', alignItems:'center'}}>
                        ...
                        <View style={{backgroundColor:'white'}}>
                            <TextInputForm style={{ width:280, height:30, position:'absolute', top:410, right:-140, borderWidth:StyleSheet.hairlineWidth, borderColor:'gray', borderRadius:10, flexDirection:'row', justifyContent:'center', alignItems:'center'}} placeholder='고객에 대한 메모' name='customerservice'/>
                        </View>
                    </View>
                </Modal>
            </TouchableOpacity>
